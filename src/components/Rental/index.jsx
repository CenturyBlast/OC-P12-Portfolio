...
import starFull from '../../data/vortex_full.png';
import starEmpty from '../../data/vortex_empty.png';
                ...
                <div className='Rental__host'>
                    ...
                    <div className='Rental__host_rating'>
                        ...
                        {[...Array(5)].map((star, index) => {
                            ...
                            return (
                                <img key={index} src={ratingScore <= dataRental.rating ? starFull : starEmpty} alt="étoile" />
                            )
                        })}
                    </div>
                </div>
